...
import ExpiringFilterSection from "./ExpiringFilterSection";
...
export default function ExpiringIndex(props) {
  ...
  suhbeader.setTitle("Expiring Report");
  ...
  useEffect(() => {
    if (props.location.state) {
      let auditObj = {
        ...
        locationObject: null,
        allocationObject: [],
        description: "Expiring Report page",
        requestObject: null,
      };
  ...
  function initialFetch(string) {
    ...
    fetch(
      `${server_path}api/ActivityReport/GetAllExpiringOverdueReport?fromDate=${formData.fromDate}&toDate=${formData.toDate}&category=${formData.category}&assetDetail=${formData.asset}&location=${formData.location}&assetStatus=${formData.status}&assetCondition=${formData.condition}&ownerBookStatus=${formData.ownerBook}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
