...
export default function AssetReturnIndex(props) {
  const suhbeader = useSubheader();

  suhbeader.setTitle("Asset Return");
  ...
  useEffect(() => {
    let arr = [];
    fetch(
      `${server_path}api/AssetDetail/GetAssetReturnList?emp_id=${parseInt(
        empID
      )}`,
      {
        headers: {
